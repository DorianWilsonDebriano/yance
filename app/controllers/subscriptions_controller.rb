class SubscriptionsController < ApplicationController
  ...
  def create_checkout_session(customer, user)
    success_url = Rails.env.development? ? "http://localhost:3000/success?session_id={CHECKOUT_SESSION_ID}" : "https://www.yancesports.com/success?session_id={CHECKOUT_SESSION_ID}"
    cancel_url = Rails.env.development? ? "http://localhost:3000/memberships" : "https://www.yancesports.com/memberships"
